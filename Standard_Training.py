...
for ds in ['CUB_200_2011','online_products']: #cars196
    for bs in [50, 100]:
        ################### INPUT ARGUMENTS ###################
        parser = argparse.ArgumentParser()

        ####### Main Parameter: Dataset to use for Training
        parser.add_argument('--dataset',      default=ds,   type=str, help='Dataset to use.')
        ...
        parser.add_argument('--bs',                default=bs,     type=int,   help='Mini-Batchsize to use.') #112
        ...
        if ds == 'CUB_200_2011':
            parser.add_argument('--source_path',  default='/home/dl-box/WorkBench/Pool/CUB200-2011/', type=str, help='Path to training data.')
        else:
            parser.add_argument('--source_path', default='/home/dl-box/WorkBench/Datasets/CVPR', type=str,
                                help='Path to training data.')  # os.getcwd()+'/Datasets'

        parser.add_argument('--save_path',    default='/home/dl-box/WorkBench/CodeBench/PyCharmProject/Project_output/Out_img_metric', type=str, help='Where to save everything.') #os.getcwd()+'/Training_Results'
